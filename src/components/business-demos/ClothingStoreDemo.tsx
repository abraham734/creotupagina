...
function ClothingStoreDemo() {
  return (
    <div className="relative">
      ...
      {/* Plano General */}
      <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 shadow-2xl border border-gray-300 max-w-6xl mx-auto">
        {/* Mock Browser Bar */}
        <div className="flex items-center space-x-2 mb-6 pb-4 border-b border-gray-300">
        ...
        {/* Plano Entero */}
        <div
          className="bg-[#113E21] rounded-xl p-8 shadow-lg text-white relative"
          style={{
        ...
        >
          <div className="backdrop-blur-sm bg-black/50 p-4 rounded-xl">
            {/* Header */}
            <div className="flex justify-between items-center mb-8 px-4 py-3 border-b border-[#B38B59]">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="md:w-1/2 space-y-4 text-left">
                <h1 className="text-5xl font-extrabold leading-tight text-[#FEFEEE]">
                  NUEVA COLECCIÓN
                </h1>
            ...
            <div className="mt-12 w-full flex justify-center">
              <div className="w-[970px] h-[60px] bg-[#FEFEEE] rounded-full overflow-hidden flex items-center justify-center shadow-inner ring-1 ring-red-300">
